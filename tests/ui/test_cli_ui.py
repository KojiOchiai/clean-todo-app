...
@patch('builtins.input', side_effect=['add --title "Test Task" --description "Test Description" --status no', 'exit'])
...
@patch('builtins.input', side_effect=['update 1 --title "Updated Task" --description "Updated Description" --status yes', 'exit'])
@patch('builtins.print')
